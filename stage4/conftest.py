# stage4/conftest.py — put stage4's own dirs on sys.path for its bare imports.
import importlib
import os
import sys
...
# Bare top-level module names stage4 SHARES with sibling stages (stage5). Running
...
# collected and before each of its tests runs. (run_stage4/rft_generate names are
# unique across stages, so they need no isolation.)
